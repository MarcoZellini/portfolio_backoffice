...
@section('content')
    ...
    <div class="container">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center">
            ...
            <a href="{{ route('admin.repositories') }}" class="btn_primary my-2 my-lg-0 mx-lg-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <a href="{{ route('admin.projects.trash') }}" class="btn_primary my-2 my-lg-0 mx-lg-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <div class="table-responsive my-3">
            <table class="table text-center align-middle">
                ...
                <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                @if (!$project->is_favourite)
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="star"
                    ...
                    @empty
                        <tr>
                            <td colspan="6">There aren't projects! 😒</td>
                        </tr>
                    @endforelse
