    ...
    <div id="jumbotron">
        <div class="container">
            @if (str_contains($project->cover_image, 'http'))
                <img class="img-fluid" src="{{ asset($project->cover_image) }}" alt="img">
            @else
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <div class="d-flex justify-content-between align-items-center fw-bold py-2">
                        <div class="fs-2">{{ $project->title }}</div>
                        @if ($project->type_id == null)
                            <div>
                                {{ 'Untyped' }}
                            </div>
                        @else
                            <a class="badge_primary text-decoration-none text_light"
                                href="{{ route('admin.types.show', $project->type->slug) }}">
                                {{ $project->type?->name }}
                            </a>
                        @endif
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-md-start justify-content-center">
                        @foreach ($project->technologies as $technology)
                            <a href="{{ route('admin.technologies.show', $technology) }}"
                                class="badge_primary text-decoration-none m-1">
                    ...
                    <div class="fw-bold py-3">
                        {{ !$project->description ? 'No description avialable!' : $project->description }}
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <a class="btn_primary mb-1" href="{{ route('admin.projects.index') }}">
                    ...
                    <a class="btn_primary mb-1" href="{{ $project->website_link }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <a class="btn_primary mb-1" href="{{ $project->github_link }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <a class="btn_primary mb-1" href="{{ route('admin.projects.edit', $project) }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                    ...
                    <a type="button" class="btn_primary mb-1" data-bs-toggle="modal"
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn_primary" data-bs-dismiss="modal">Close</button>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a
                                    href="{{ $project->type_id != null ? route('admin.types.show', $project->type) : '#' }}">
