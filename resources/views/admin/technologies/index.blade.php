...
@section('page-title', 'Admin - Technologies')
...
@section('content')
    ...
    <div class="container">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center">
            ...
            <a class="btn_primary my-2 my-lg-0 mx-lg-2" href="{{ route('admin.technologies.create') }}">
            ...
            <a class="btn_primary my-2 my-lg-0 mx-lg-2" href="{{ route('admin.technologies.trash') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <tbody>
                    ...
                    @forelse ($technologies as $technology)
                        <tr class="">
                            ...
                            <td class="d-none d-lg-table-cell"><small>{{ date($technology->created_at) }}</small></td>
                            <td>
                                <div class="row row-cols-xl-3 m-0">
                                    <div class="col px-1">
                                    ...
                                    @forelse ($technologies as $technology)
                                        <tr class="">
                                            ...
                                            <td>
                                                ...
                                                <!-- Modal Body -->
                                                <!-- if you want to close by clicking outside the modal, delete the last endpoint:data-bs-backdrop and data-bs-keyboard -->
                                                <div class="modal fade" id="modalId-{{ $technology->id }}"
