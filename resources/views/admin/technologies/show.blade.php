...
@section('page-title', 'Admin - Technology ' . $technology->id)
    ...
    <div class="container">
        ...
        <div class="d-flex flex-column flex-lg-row align-items-lg-center">
            <div class="flex-grow-1">
                <small class="m-0">Technology ID: # {{ $technology->id }}</small>
                <h2 class=" text-capitalize">{{ $technology->name }}</h2>
            </div>

            <a class="btn_primary my-2 my-lg-0 mx-lg-2" href="{{ route('admin.technologies.index') }}">
            ...
            <a class="btn_primary my-2 my-lg-0 mx-lg-2" href="{{ route('admin.technologies.edit', $technology) }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
            ...
            <a type="button" class="btn_primary my-2 my-lg-0 mx-lg-2" data-bs-toggle="modal"
                ...
                <tbody>
                    @forelse ($projects as $project)
                        <tr>
                            ...
                            <td>
                                <div class="row row-cols-2 row-cols-xl-4 m-0">
                                    <div class="col px-1">
                                        <a class="btn_primary m-1 mx-sm-0 mb-sm-0"
                                    ...
                                    <div class="col px-1">
                                        <a class="btn_primary m-1 mx-sm-0 mb-sm-0" href="{{ $project->github_link }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <div class="col px-1">
                                        <!-- Modal trigger button -->
                                        <a type="button" class="btn_primary m-1 mx-sm-0 mb-sm-0" data-bs-toggle="modal"
