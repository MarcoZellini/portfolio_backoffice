...
@section('page-title', 'Admin - Trashed Technologies')
        ...
        <div class="table-responsive my-3">
            <table class="table text-center align-middle">
                ...
                <tbody>
                            ...
                            <td>
                                <div class="row row-cols-1 row-cols-md-2 m-0">
                                    <div class="col px-1">
                                        ...
                                        <div class="modal fade" id="modalId-restore-{{ $technology->id }}" tabindex="-1"
                    ...
                    @empty
                        <tr>
                            <td colspan="4">There aren't technologies! 😒</td>
                        </tr>
                    @endforelse
